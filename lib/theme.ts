...
export const shadows = {
  ...
  brandGlow: '0 0 0 1px rgba(59, 130, 246, 0.15), 0 0 25px rgba(59, 130, 246, 0.1)',
  aiGlow: '0 0 20px rgba(0, 212, 255, 0.3), 0 0 40px rgba(0, 212, 255, 0.1)',
  successGlow: '0 0 0 1px rgba(16, 185, 129, 0.15), 0 0 25px rgba(16, 185, 129, 0.1)',
  errorGlow: '0 0 0 1px rgba(239, 68, 68, 0.15), 0 0 25px rgba(239, 68, 68, 0.1)',
} as const;
...
export const gradients = {
  ...
  `,
  subtle: {
    primary: 'linear-gradient(135deg, rgba(59, 130, 246, 0.05) 0%, rgba(168, 85, 247, 0.05) 100%)',
