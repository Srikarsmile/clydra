...
export default function InputBar({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 pointer-events-none">
      {/* Centered container - no sidebar offset */}
      <div className="mx-auto w-full max-w-4xl px-4 md:px-6 pb-4 transition-all duration-300 pointer-events-auto flex justify-center">
        {/* @fluid-scroll - Enhanced container with smooth backdrop */}
        <div className="bg-surface/95 backdrop-blur-xl border border-gray-200/60 rounded-2xl shadow-2xl transition-all duration-300 hover:shadow-3xl hover:bg-surface/98 w-full max-w-3xl">
